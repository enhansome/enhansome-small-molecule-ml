...
* Yang et al, 2019. [Analyzing Learned Molecular Representations for Property Prediction (Chemprop)](https://pubs.acs.org/doi/10.1021/acs.jcim.9b00237). \[[Code](https://github.com/chemprop/chemprop) ⭐ 2,438 | 🐛 13 | 🌐 Python | 📅 2026-08-21]
...
* Zhou et al, 2019. [Optimization of Molecules via Deep Reinforcement Learning](https://doi.org/10.1038/s41598-019-47148-x). \[[Code (official version)](https://github.com/google-research/google-research/tree/master/mol_dqn) ⭐ 38,630 | 🐛 1,988 | 🌐 Jupyter Notebook | 📅 2026-08-27] \[[PyTorch implementation](https://github.com/aksub99/MolDQN-pytorch) ⭐ 84 | 🐛 7 | 🌐 Python | 📅 2023-03-24]
...
* Polishchuk, 2020. [CReM: chemically reasonable mutations framework for structure generation](https://jcheminf.biomedcentral.com/articles/10.1186/s13321-020-00431-w). \[[Code](https://github.com/DrrDom/crem) ⭐ 282 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2026-08-26]
...
* Goldman el al, 2023. [Prefix-Tree Decoding for Predicting Mass Spectra from Molecules](https://arxiv.org/abs/2303.06470). \[[Code](https://github.com/samgoldman97/ms-pred) ⭐ 151 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2026-08-19]
...
* [DeepChem](https://deepchem.io/) \[[Tutorials](https://github.com/deepchem/deepchem/tree/master/examples/tutorials) ⭐ 6,962 | 🐛 1,165 | 🌐 Python | 📅 2026-08-20]
* [Chemprop](https://github.com/chemprop/chemprop) ⭐ 2,438 | 🐛 13 | 🌐 Python | 📅 2026-08-21
